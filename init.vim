...
let g:coc_global_extensions = ['coc-python', 'coc-vimlsp', 'coc-tsserver', 'coc-yank', 'coc-lists', 'coc-vimlsp', 'coc-tailwindcss', 'coc-stylelint', 'coc-tslint', 'coc-lists', 'coc-explorer', 'coc-pyright', 'coc-sourcekit', 'coc-translator', 'coc-clangd', 'coc-highlight']
